...
from OTCamera.netwatch.monitor import NetworkStatusWriter, NetworkMonitor, HttpNetworkProbe
...
def main():
    ...
    escalations = [
        Escalation(after=15, action=lambda: print("Boy, that escalated with a bit of a delay!")),
